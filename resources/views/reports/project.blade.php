            ...
            <div class="report-row row align-items-center">
                <div class="col">
                    <div class="form-group">
                        <label for="project_id">{{ __('app.reports_index_options_project_label') }}</label>
                        <div class="select">
                            <select name="project_id" id="project_id" class="form-control select2">
                                @foreach ($projects_select as $key => $value)
                                <option value="{{ $key }}" {{ $key == $current_project ? 'selected="selected"' : '' }}>{{ $value }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="col-auto">
                    ...
                    <div class="dropdown d-inline">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="{{ route('reports.project', ['project_id' => $current_project, 'month' => $now->format('n'), 'year' => $now->format('Y')]) }}" class="dropdown-item @if($active_item == 1) active @endif">{{ __('app.reports_index_options_period_thismonth_button') }}</a>
                            <a href="{{ route('reports.project', ['project_id' => $current_project, 'month' => $last_month->format('n'), 'year' => $last_month->format('Y')]) }}" class="dropdown-item @if($active_item == 2) active @endif">{{ __('app.reports_index_options_period_lastmonth_button') }}</a>
                            <a href="{{ route('reports.project', ['project_id' => $current_project, 'week' => $now->format('o\WW')]) }}" class="dropdown-item @if($active_item == 3) active @endif">{{ __('app.reports_index_options_period_thisweek_button') }}</a>
                            <a href="{{ route('reports.project', ['project_id' => $current_project, 'week' => $last_week->format('o\WW')]) }}" class="dropdown-item @if($active_item == 4) active @endif">{{ __('app.reports_index_options_period_lastweek_button') }}</a>
                            <div class="dropdown-divider"></div>
                            <a href="{{ route('reports.project', ['project_id' => $current_project, 'all' => 1]) }}" class="dropdown-item @if($active_item == 5) active @endif">{{ __('app.reports_index_options_period_showall_button') }}</a>
                        </div>
                    </div>
                </div>
            </div>
